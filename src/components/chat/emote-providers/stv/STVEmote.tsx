  ...
  return (
    ...
    >
      ...
      <TooltipContent className={classes["stv-emote-tooltip"]}>
        <img
          className={classes["stv-emote-tooltip__image"]}
          src={enlargedEmoteSource}
          alt={emoteName}
        />
        <p className={classes["stv-emote-tooltip__text"]}>Emote: {emoteName}</p>
        <p className={classes["stv-emote-tooltip__text"]}>From: 7TV</p>
        <p className={classes["stv-emote-tooltip__text"]}>By: {emoteAuthor}</p>
      </TooltipContent>
    </Tooltip>
  );
};
